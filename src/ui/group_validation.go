...
var (
	// validGroupNamePattern allows alphanumeric, dash, underscore, @, dot, forward slash, comma, equals
	// This covers most OIDC providers: Azure AD (including DN format), Okta, Google, Keycloak, etc.
...
func validateGroupName(name string) error {
	...
	if !validGroupNamePattern.MatchString(name) {
		return fmt.Errorf("invalid characters in group name (allowed: a-z A-Z 0-9 . _ @ / , = -)")
	}
