...
// isRenovateDashboard checks if the issue body is a Renovate Dependency Dashboard.
func isRenovateDashboard(body string) bool {
	return strings.Contains(body, "This issue lists Renovate updates and detected dependencies.")
}

// isRenovatePR checks if the pull request body was generated by Renovate.
func isRenovatePR(body string) bool {
	return strings.Contains(body, "This PR has been generated by [Renovate Bot]")
}
...
func isValidForgejoEvent(event string, payload *ForgejoEvent) (bool, string) {
	...
	case "issues":
		...
		if !isRenovateDashboard(payload.Issue.Body) {
			return false, "not a Renovate Dependency Dashboard"
		}
		if !hasCheckboxBeenChecked(payload.Issue.Body) {
	...
	case "pull_request":
		...
		if !isRenovatePR(payload.PullRequest.Body) {
