function ThemeToggle() {
  ...
  return (
    <button
      onClick={cycleTheme}
      className="p-1.5 rounded-lg border border-gray-300 dark:border-slate-600 hover:bg-gray-100 dark:hover:bg-slate-700 transition-all text-gray-700 dark:text-slate-200"
      aria-label={label}
    >
      {theme === 'light' ? (
